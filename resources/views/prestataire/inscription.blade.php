            ...
            <form id="multiStepForm" action="{{ route('prestataire.inscription') }}" method="POST">
                ...
                <div class="step">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nom_entreprise"
                               class="mt-1 block w-full px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring focus:ring-blue-200">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="adresse_facturation"
                               class="mt-1 block w-full px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:ring focus:ring-blue-200">
                    </div>
                    <div class="mb-4">
                    ...
                    <button type="button"
                            class="nextStep w-full bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 transition duration-200">
                        Suivant
                    </button>
                </div>
                ...
                <div class="step hidden">
                    ...
                    <div class="flex justify-between">
                        <button type="button"
                                class="prevStep w-full mr-2 bg-gray-500 text-white py-2 px-4 rounded-md hover:bg-gray-600 transition duration-200">
                            Précédent
                        </button>
